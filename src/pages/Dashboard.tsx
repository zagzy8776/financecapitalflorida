        ...
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-16 flex items-center justify-between gap-4">
            <Link
              ...
              className="rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#b68a45]/60"
            >
            ...
            <div className="flex items-center gap-2.5">
              ...
              <Link
                to="/profile"
                aria-label="Profile"
                className="w-9 h-9 rounded-full bg-gradient-to-br from-[#c9a05a] to-[#b68a45] flex items-center justify-center text-[#0c1b33] text-sm font-bold shadow-md shadow-amber-900/15 ring-2 ring-[#e6ebf1]"
              >
                {user?.full_name
                  ?.split(/\s+/)
                  .map((w) => w[0])
